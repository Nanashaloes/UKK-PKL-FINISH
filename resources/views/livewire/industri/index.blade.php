                ...
                <table class="min-w-full text-sm text-gray-700 border-collapse">
                    <thead class="bg-gradient-to-r from-blue-700 to-blue-600 text-white text-xs uppercase sticky top-0 z-10">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left font-medium tracking-wider">Bidang Usaha</th>
                            <th class="px-6 py-3 text-left font-medium tracking-wider">Alamat</th>
                            <th class="px-6 py-3 text-left font-medium tracking-wider">Kontak</th>
                            <th class="px-6 py-3 text-left font-medium tracking-wider">Guru Pembimbing</th>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @forelse ($industriList as $industri)
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-3">
                                    {{ $industri->guru->nama ?? 'Guru Tidak Ditemukan' }}
                                </td>
